# Creator File Manager — エージェント向けプロジェクトガイド
...
| MSI | `src-tauri/target/release/bundle/msi/Creator File Manager_*.msi` |
| NSIS | `src-tauri/target/release/bundle/nsis/Creator File Manager_*-setup.exe` |
